...
`.trim(),
  ...
  /** V4-N — corpus sémantique ciblé (A–V). */
  form2042CPro: `
Direction générale des Finances publiques
Formulaire n°2042-C-PRO
Déclaration de revenus complémentaire — professions non salariées
Revenus de l'année 2024
`.trim(),
...
`.trim(),
  ...
  invoiceLooksLikeCerfa: `
Facture n°10330
Prestations informatiques
Total TTC : 480,00 €
`.trim(),

  yearMismatchIncomeVsDoc: `
Direction générale des Finances publiques
Déclaration des revenus — Formulaire 2042
Revenus de l'année 2024
Date de signature : 12/05/2025
`.trim(),
  ...
  titleFiscalNoReference: `
Direction générale des Finances publiques
Déclaration des revenus
Revenus de l'année 2024
Traitements et salaires : 22 000,00 €
`.trim(),

  titleRefContradiction: `
Direction générale des Finances publiques
Formulaire n°2044 — Déclaration des revenus
(titre incohérent avec la référence foncière)
Loyers bruts : 8 000,00 €
`.trim(),

  knowledgeNoUserValue: `
Direction générale des Finances publiques
Formulaire n°2042 — Déclaration des revenus
Aucune case chiffrée n'est remplie sur cet exemplaire.
`.trim(),

  knowledgeNoAction: `
Direction générale des Finances publiques
Formulaire n°2047 — Déclaration des revenus encaissés à l'étranger
Document informatif sans échéance ni demande de paiement.
`.trim(),

  ocr204Z: `
Direction générale des Finances publiques
Formulaire n°204Z — Déclaration des revenus
Revenus de l'année 2024
`.trim(),

  nonFiscalContains2042: `
Guide pratique du locataire
Voir aussi le formulaire 2042 pour vos impôts, hors sujet ici.
Adresse du bien : 10 rue Victor Hugo
`.trim()
};
