...
if (
   ...
   */
  if (
    /montant à payer|montant a payer|montant à régler|montant a regler|net à payer|net a payer|reste à payer|reste a payer|montant dû|montant du|total à régler|total a regler|somme à régler|somme a regler|à régler|a regler|à payer|a payer/.test(
      ctx
    )
  ) {
    return {
