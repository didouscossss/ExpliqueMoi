...
export function interpretAmountRole(
   ...
   */
  if (
    /capital social|au capital de|capital de la société|capital de la societe|capital\s*[:\-]|capitalisation|capital souscrit|capital détenu|capital detenu/.test(
      ctx
    )
  ) {
    return {
   ...
   */
  if (
    /tableau|ligne|case|rubrique/.test(ctx) &&
    family === "fiscal"
  ) {
    return {
      role: "table_value",
