...
export const EMPLOI_KNOWLEDGE = [
   ...
   * ---------------------------------------------------
   *
   * Absente jusqu'ici du catalogue : ce document (accusé de
   * réception, convention elle-même, décision d'homologation...)
   * partage du vocabulaire avec "Contrat de travail" ("le contrat
   * de travail prendra fin le...", "employeur", "salarié") sans en
   * être un, et tombait donc dessus par erreur — avec un résumé
   * inventé ("définit le poste, la rémunération...") qui ne
   * correspond à rien dans le document réel.
   */
  ...
  createKnowledgeDocument({
    ...
    aliases: [
      ...
      "demande d homologation",
      "accusé de réception d'homologation",
      "accuse de reception d homologation"
    ],
    ...
    summary:
      "Ce document concerne une rupture conventionnelle de contrat de travail (entretien, délai de rétractation, homologation par l'administration) et précise les dates clés de la procédure.",

    importantFields: [
      "date de l'entretien préalable",
      "date de signature de la convention",
      "fin du délai de rétractation",
      "date limite d'homologation",
