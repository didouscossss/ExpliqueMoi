...
export const BANQUE_KNOWLEDGE = [
   ...
   * ---------------------------------------------------
   *
   * Distincte du RIB lui-même : ce document ANNONCE la prise
   * en compte d'un nouveau RIB par un tiers (employeur,
   * organisme), il n'EST pas le RIB.
   */
  ...
  createKnowledgeDocument({
    ...
    aliases: [
      ...
      "changement de coordonnees bancaires",
      "mise à jour de vos coordonnées bancaires",
      "mise a jour de vos coordonnees bancaires"
    ],
    ...
    phrases: [
      "nous confirmons la prise en compte de votre nouveau rib",
      "changement de coordonnées bancaires",
      "changement de coordonnees bancaires",
      "mise à jour de vos coordonnées bancaires",
      "mise a jour de vos coordonnees bancaires"
    ...
    summary:
      "Ce document confirme la prise en compte d'un changement de coordonnées bancaires pour vos futurs versements ou prélèvements.",
