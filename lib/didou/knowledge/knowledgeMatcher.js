...
function scoreKnowledge({
   ...
   * ===================================================
   *
   * "type" et "alias" (le nom même de la fiche retrouvé tel
   * quel dans le texte, 60 points) sont exclus de ce
   * décompte : un nom de fiche générique ou court double
   * souvent comme vocabulaire ordinaire dans un contexte sans
   * rapport ("transmettre les devis de réparation" ne fait
   * pas de ce document un "Devis"). Sans cette exclusion, ce
   * signal isolé se faisait lui-même passer pour un "signal
   * fort" et échappait au plafond de sécurité ci-dessous —
   * alors que c'est justement le cas qu'il doit couvrir.
   */
