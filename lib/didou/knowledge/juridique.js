...
export const JURIDIQUE_KNOWLEDGE = [
  ...
  createKnowledgeDocument({
    ...
    phrases: [
      ...
      "montant de l amende forfaitaire",
      "montant majoré si paiement tardif",
      "montant majore si paiement tardif",
      "avis de contravention"
    ],
    ...
    summary:
      "Ce document vous notifie une infraction et le montant de l'amende forfaitaire à régler, ou vous permet de la contester.",
    ...
    ignoredFields: [
      "mentions légales",
      "modalités de recours détaillées"
    ]
  })
];
