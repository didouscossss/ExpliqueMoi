...
export const SOCIAL_KNOWLEDGE = [
  ...
  /**
   * ---------------------------------------------------
   * Notification de radiation France Travail
   * ---------------------------------------------------
   *
   * Distincte de la convocation elle-même : ce document
   * notifie une RADIATION (souvent suite à une absence à
   * convocation), avec un délai de recours à respecter — ce
   * n'est ni un rendez-vous à venir, ni une simple information
   * de droits.
   */
  ...
  createKnowledgeDocument({
    ...
    summary:
      "Ce document vous notifie votre radiation de la liste des demandeurs d'emploi et précise le délai dont vous disposez pour la contester.",
