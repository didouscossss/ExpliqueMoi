  ...
  const scored =
    list
      .map((date) => {
         ...
         */
        if (
          /date de l assemblee|assemblee generale du|assemblee du/.test(
            context
          )
        ) {
          score += 150;
        ...
        if (
          /elle se tiendra le|se tiendra le|aura lieu le/.test(
            context
          )
        ) {
          score += 150;
        ...
        if (
          /assemblee generale|assemblee|convocation|\bag\b|reunion/.test(
            context
          )
        ) {
          score += 90;
        ...
        /*
         * La présence d'une heure proche est un
         * excellent signal.
         */
        if (
        ...
        /*
         * Date du courrier :
         * surtout ne pas la choisir comme AG.
         */
        if (
          /poitiers le|tours le|paris le|fait le|date du courrier|edite le|edite, le|émis le|emis le/.test(
            context
          )
        ) {
          score -= 140;
        ...
        /*
         * Dates comptables / exercices.
         */
        if (
          /exercice|charges|releve de compte|budget|facture|echeance|appel de fonds|travaux/.test(
            context
          )
        ) {
          score -= 100;
        ...
        /*
         * Vérification directe dans le texte :
         * si la date apparaît près d'un bloc "assemblée".
         */
        const rawNormalized =
          normalizeText(
            raw
