...
function extractMeetingPlace(
  ...
  collectPlaceCandidates(
    source,
    /\b(?:se tiendra|aura lieu)[\s\S]{0,120}?(?<![a-zà-ÿ])(?:à|a|au|aux)\s+/gi,
    150,
    100,
    candidates
  );
   ...
   * aucun lieu n'était jamais détecté sur ce type de document.
   */
  collectPlaceCandidates(
    source,
    /\br(?:é|e)uni[a-z]*[\s\S]{0,60}?(?<![a-zà-ÿ])(?:à|a|au|aux)\s+/gi,
    150,
    100,
    candidates
  );
