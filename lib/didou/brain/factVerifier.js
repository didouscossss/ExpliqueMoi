...
function verifyAmounts(brain) {
  ...
  for (const amount of amounts) {
    ...
    /*
     * ===================================================
     * RÉSULTAT FINANCIER (BILAN / LIASSE FISCALE)
     * ===================================================
     */

    if (
      isFinancialResultRole(role)
    ) {
      let score =
        confidence;

      if (
        /resultat fiscal|resultat comptable|resultat net|resultat de l.exercice|chiffre d.affaires/.test(
          context
        )
      ) {
        score += 10;
        ...
        verificationReason =
          "Le montant correspond au résultat financier de l'exercice.";
      }
      ...
      finalizeAmountVerification(
        ...
        score,
        {
          verificationReason:
            verificationReason ||
            "Montant identifié comme résultat financier de l'exercice."
        }
      );
...
function isFinancialResultRole(role) {
