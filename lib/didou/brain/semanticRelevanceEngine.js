...
function isRealUserAction(
  ...
  /*
   * Applicabilité très faible => non.
   */
  if (
    semantics.applicability?.level ===
      APPLICABILITY.THIRD_PARTY ||
    semantics.applicability?.score < 30
  ) {
    return false;
  }
  ...
  /*
   * Condition = seulement si suffisamment applicable.
   */
  if (
    semantics.role ===
      ACTION_ROLE.CONDITIONAL &&
    semantics.applicability?.score < 50
  ) {
    return false;
  }
 ...
 *
 * - rôle des dates V2
 * - rôle des montants V2
 * - détection des montants conditionnels
 * - pénalité des montants secondaires
 ...
 */
/* ============================================================
 * 31. ROLE SEMANTIQUE D'UNE DATE — V2
 * ============================================================
 *
 * IMPORTANT :
 *
 * Une date n'est jamais importante uniquement parce qu'elle
 * ressemble à une date.
 *
 * On cherche ce qu'elle REPRESENTE.
 * ============================================================
 */
...
/* ============================================================
 * 34. SCORE FINAL D'UNE DATE
 * ============================================================
 *
 * Le rôle seul ne suffit plus.
 *
 * Exemple :
 *
 * DEADLINE
 * + centrale
 * + applicable utilisateur
 * = très forte
 *
 * DEADLINE
 * + annexe
...
/* ============================================================
 * 40. ANALYSE SEMANTIQUE COMPLETE D'UN MONTANT
 * ============================================================
 */
...
function canBePrimaryAmount(
   ...
   *
   * tarif conditionnel ≠ somme actuellement due.
   */
...
/* ============================================================
 * 50. SELECTION MONTANT PRINCIPAL — V2
 * ============================================================
 */
