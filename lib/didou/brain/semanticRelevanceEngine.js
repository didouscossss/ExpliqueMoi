 ...
 * --------------------------------------------------------
 *
 * Une date n'est une date d'événement que si elle est
 * directement reliée à la tenue de cet événement.
 *
 * "assemblée" ou "réunion" dans le voisinage ne suffit pas.
 */
...
/*
 * ========================================================
 * 1 — CONTEXTES QUI EXCLUENT UNE DATE DE REUNION
 * ========================================================
 *
 * Ces expressions décrivent des périodes comptables,
 * historiques, juridiques ou contractuelles.
 */
...
/*
 * Si la date se trouve clairement dans un contexte
 * comptable/juridique/etc., elle ne peut pas devenir
 * meetingDate grâce au simple mot "assemblée".
 */
...
if (!nonMeetingDateContext) {
  ...
  if (escapedDate) {
    /*
     * =====================================================
     * 2 — LIENS FORTS ENTRE EVENEMENT ET DATE
     * =====================================================
     *
     * Ici on cherche des formulations qui signifient
     * réellement "cet événement se passe à cette date".
     */
  ...
  /*
   * Date reliée à un événement générique.
   */
 ...
 * --------------------------------------------------------
 *
 * Une simple présence de vocabulaire événementiel
 * dans le contexte ne suffit pas.
 *
 * On exclut d'abord les dates qui décrivent clairement
 * une période, une référence juridique, un exercice,
 * un budget ou une opération comptable.
 */
