...
const ACTION_PATTERNS = [
  ...
  {
    re: new RegExp(
      `\\b(?:doit|doivent)\\s+(?:etre|être)\\s+(?:transmis|envoye?|envoyé|retourne|retourné|regle|réglé|acquitte|acquitté|complete|complété|rempli|signe|signé|fourni|renvoye|renvoyé|paye|payé|regularise|régularisé|adresse|adressé|restitue|restitué|deposé|depose)e?s?\\b${TAIL0_120}`,
      "gi"
    ),
    kind: "request"
  },
