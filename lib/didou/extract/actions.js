...
const ACTION_PATTERNS = [
  ...
  {
    re: /\bmerci\s+de\s+(?:(?:bien\s+)?(?:nous\s+)?(?:transmettre|envoyer|retourner|compléter|completer|signer|fournir|joindre|répondre|repondre|régler|regler|payer|confirmer|contacter|appeler|participer|voter|régulariser|regulariser|rembourser))\b[^.!\n]{0,140}/gi,
    kind: "request"
  },
  ...
  {
    re: /\b(?:à\s+retourner|a\s+retourner|à\s+payer|a\s+payer|régler|regler|transmettre|envoyer|répondre|repondre|compléter|completer|signer|fournir|joindre|confirmer|contacter|appeler|participer|donner\s+procuration|voter|régulariser|regulariser|rembourser)\b[^.!\n]{0,120}/gi,
    kind: "action"
  },
