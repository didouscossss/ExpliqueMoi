...
function detectDateHint(
   ...
   */
  if (
    /assemblee generale|assemblee|\bag\b|reunion|convocation|convoque|convoquee|se tiendra|aura lieu|comparaitre|a comparaitre|rendez-vous|vous presenter/.test(
      text
    )
  ) {
    return "meetingDate";
